...
Thanks for using magrittr! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tidyverse/magrittr/issues/new).
...
requests](https://github.com/tidyverse/magrittr/issues) to make sure the
