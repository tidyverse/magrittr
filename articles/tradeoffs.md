...
- **Progressive stack**: using the pipe should add as few entries to the
  call stack as possible, so that
  [`traceback()`](https://rdrr.io/r/base/traceback.html) is maximally
  useful.
...
#> function () 
#> x
#> <bytecode: 0x564fa4643e58>
#> <environment: 0x564fa47aa758>
```
...
Arguments are assigned with
[`delayedAssign()`](https://rdrr.io/r/base/delayedAssign.html) and
lazily evaluated:
...
Stack-sensitive functions like
[`return()`](https://rdrr.io/r/base/function.html) function cannot find
the proper frame environment:
