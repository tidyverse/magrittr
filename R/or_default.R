...
# @param  fallback_value a fallback value that will be returned if the first parameter is NULL or NA.
...
#' 
#' @details The operator only returns the rhs when lhs is NULL or NA. 
