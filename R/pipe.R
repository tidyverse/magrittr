...
pipe <- function()
{
  function(lhs, rhs)
  {
    ...
    if (is_placeholder(lhs)) {
      ...
      # If compound assignment pipe is used, assign result
...
#' @param rhs a function call using the magrittr semantics.
#' 
#' @details The compound assignment pipe, \code{\%<>\%}, is used to
...
#' @param rhs A function call using the magrittr semantics.
#' 
#' @details The tee assignment pipe works like \code{\link{\%>\%}}, except the 
