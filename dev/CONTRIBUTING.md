...
This outlines how to propose a change to magrittr. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tidyverse/magrittr", fork = TRUE)`.
...
Code of Conduct](https://magrittr.tidyverse.org/dev/CODE_OF_CONDUCT.md).
